      ...
      <Container className="py-16 sm:py-20">
        <div className="grid gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 max-w-sm text-ivory/70">{siteConfig.tagline}</p>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:col-span-7">
            {footerNav.map((col) => (
              <nav key={col.heading}>
                <h3 className="text-xs uppercase tracking-[0.2em] text-ivory/50">
                  {col.heading}
                </h3>
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-5 border-t border-ivory/10 pt-7 sm:flex-row">
          <p className="text-xs text-ivory/55">
            © {year} {siteConfig.name}. Handcrafted, made to order.
          </p>
