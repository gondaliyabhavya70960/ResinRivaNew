...
import { LayoutDashboard, Package, FolderTree, Image as ImageIcon } from "lucide-react";
...
export function StudioSidebar() {
  ...
  return (
    <aside className="flex shrink-0 border-b bg-card md:sticky md:top-0 md:h-dvh md:w-56 md:flex-col md:border-r md:border-b-0">
